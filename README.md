...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-xtrans-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-xtrans-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-xtrans
# for installing globally
pixi global install xorg-xtrans
```
...
It is possible to list all of the versions of `xorg-xtrans` available on your platform:
...
```
pixi search xorg-xtrans --channel conda-forge
```
